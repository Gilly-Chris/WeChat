package com.example.wechat.ui.different_user_profile
...
import com.example.wechat.databinding.DifferentUserProfileFragmentBinding
import com.example.wechat.ui.main.MainViewModel
import com.example.wechat.ui.profile.FriendsAdapter
...
class DifferentUserProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this)[DifferentUserProfileFragmentViewModel::class.java]
        ...
        viewModel.checkIfFriends(user.uid).observe(this, { friendRequestState ->
        ...
        viewModel.loadedImage.observe(this,  {
        ...
        sharedViewModel.loadFriends(user).observe(this, { friendsList ->
