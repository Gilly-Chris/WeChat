...
import com.example.wechat.databinding.UserItemBinding
import java.util.*
var mQuery = ""

class UsersAdapter(private val clickListener: UserClickListener) : ListAdapter<User, UsersAdapter.ViewHolder>(DiffCallbackUsers()),
