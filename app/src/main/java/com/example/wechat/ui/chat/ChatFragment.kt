...
import com.example.wechat.Util.eventbus_events.PermissionEvent
import com.example.wechat.Util.eventbus_events.UpdateRecycleItemEvent
import com.example.wechat.data.model.*
import com.example.wechat.databinding.ChatFragmentBinding
...
class ChatFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.loadMessages().observe(this, { mMessagesList ->
        ...
        binding.attachmentLayout.sendPictureButton.setOnClickListener {
            selectFromGallery()
            mBottomSheetBehavior.state = BottomSheetBehavior.STATE_COLLAPSED
        }

        binding.attachmentLayout.sendFileButton.setOnClickListener {
            openFileChooser()
            mBottomSheetBehavior.state = BottomSheetBehavior.STATE_COLLAPSED
        }

        binding.attachmentLayout.hide.setOnClickListener {
            mBottomSheetBehavior.state = BottomSheetBehavior.STATE_COLLAPSED
        }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == SELECT_CHAT_IMAGE_REQUEST && data != null && resultCode == AppCompatActivity.RESULT_OK) {
            ...
            viewModel.uploadChatImageByUri(data.data)
                .observe(this, { uploadedChatImageUri ->
