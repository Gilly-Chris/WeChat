...
import com.example.wechat.databinding.IncomingRequestsFragmentBinding
...
class IncomingRequestsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.incoming_requests_fragment, container, false)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        viewModel = ViewModelProvider(this)[IncomingRequestsViewModel::class.java]
        ...
        if (!receivedRequest.isNullOrEmpty()) {
            viewModel.downloadRequests(receivedRequest).observe(this, { requestersList ->
                //hide loading
