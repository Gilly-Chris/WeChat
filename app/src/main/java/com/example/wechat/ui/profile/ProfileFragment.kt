package com.example.wechat.ui.profile
...
import com.example.wechat.databinding.ProfileFragmentBinding
...
class ProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sharedViewModel.loadFriends(loggedUser).observe(this, { friendsList ->
            //hide loading
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        viewModel.uploadImageLoadStateMutableLiveData.observe(this, { imageUploadState ->
            setProfileImageLoadUi(imageUploadState)
        })

        //set new image in profile image view
        viewModel.newImageUriMutableLiveData.observe(this, {
