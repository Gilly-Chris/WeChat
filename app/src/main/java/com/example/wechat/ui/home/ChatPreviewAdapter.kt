...
import com.example.wechat.databinding.ChatOuterItemBinding
import java.util.*
...
class ChatPreviewAdapter(private val clickListener: ClickListener) :
            ...
            override fun performFiltering(charSequence: CharSequence): FilterResults {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (chatParticipant in chatList) {
                        if (chatParticipant.particpant?.username?.lowercase(Locale.ENGLISH)?.contains(
    ...
    class ViewHolder private constructor(private val binding: ChatOuterItemBinding) :
